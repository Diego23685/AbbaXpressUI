...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-slate-100 font-sans text-slate-800 antialiased overflow-hidden">
      ...
      {/* Sidebar Corporativo */}
      <aside className="w-64 bg-brand-darker text-slate-300 flex flex-col border-r border-slate-800 select-none print:hidden">
        
        {/* Logo & Marca */}
        <div className="p-4 flex items-center gap-3 border-b border-slate-800/80 bg-brand-dark">
        ...
        <nav className="flex-1 px-3 space-y-1.5 overflow-y-auto">
          ...
          {/* Opciones para Administradores (Super Admin y Admin León) */}
        ...
        {/* Botones inferiores: Ver Tutorial de Ayuda & Cerrar Sesión */}
